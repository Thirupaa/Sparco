...
let BUSD_WBNB_PAIR = "0xecb4a30d39f0f73312eebef4b0bfba355d87fd70"; // created block 18554602
// let USDT_WBNB_PAIR = "0xaaf85046837a93cf6c527c0a3e45c2a1e2c04be0"; // created block 648115
...
//  let usdtPair = Pair.load(USDT_WBNB_PAIR); // usdt is token0
  ...
  if (busdPair !== null) {
    let totalLiquidityBNB = busdPair.reserve0;
